...
export const BUCKET_OPTIONS: BucketMeta[] = [
  ...
  { bucket: "ira", label: "IRA (traditional)", base: "gross", preTax: true, cap: "7500" },
  { bucket: "hsa", label: "HSA", base: "gross", preTax: true, cap: "4400" },
  { bucket: "roth_401k", label: "Roth 401(k)", base: "gross", preTax: false, cap: "24500" },
  { bucket: "roth_ira", label: "Roth IRA", base: "gross", preTax: false, cap: "7500", defaultEnabled: true, defaultPercent: 5 },
